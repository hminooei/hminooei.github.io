...
2- Furthermore, we're currently only worried about bad actors at inference—soon they'll be able to exploit the training stage, too (see OpenAI's recent post on the [Hugging Face incident](https://openai.com/index/hugging-face-incident-and-the-road-ahead/)).

We can mitigate some risks, but the risk is far too massive to dismiss the big labs' safety concerns as mere marketing or IPO hype.